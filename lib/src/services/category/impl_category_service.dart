...
class ImplCategoryService extends CategoryService {
  ...
  Future<List<Category>> fetchCategory() async {
    final uri = Uri(
      ...
      path: AppConfig.instance.getValue(AppConstants.cryptoPath) + AppConfig.instance.getValue(AppConstants.categoryPath),
    );
    ...
    if (response.statusCode == 200) {
      ...
      var categories =
          List<Category>.from(responseList.map((model) => Category.fromJson(model)));
